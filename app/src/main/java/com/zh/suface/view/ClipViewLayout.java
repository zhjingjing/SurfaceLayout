...
public class ClipViewLayout extends RelativeLayout {
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        imageView.setBackgroundColor(context.getResources().getColor(R.color.bg_black));
        //相对布局布局参数
...
//            return;
//        }
//        L.e(ClipViewLayout.class, "**********clip_view uri*******  " + uri);
//        String path = getRealFilePathFromUri(getContext(), uri);
//        L.e(ClipViewLayout.class, "**********clip_view path*******  " + path);
...
//        matrix.postTranslate(imageView.getMaxWidth(), imageView.getMaxHeight());
        imageView.setScaleType(ImageView.ScaleType.MATRIX);
    ...
    public Bitmap clip() {
        ...
        try {
            ...
            zoomedCropBitmap = comp(cropBitmap);
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (cropBitmap != null) {
